...
@Mod("formula")
public class FormulaMod {
	public static final Logger LOGGER = LogManager.getLogger(FormulaMod.class);
	public static final String MODID = "formula";
